package com.wsy.online.common.http.support;

import androidx.annotation.Nullable;

import com.blankj.utilcode.util.EncryptUtils;
import com.wsy.online.common.http.config.ConfigKtKt;


public class ChinaLanguageUtils {
    private ChinaLanguageUtils() {
    ...
    public static String decodeData(@Nullable String dataStr) {
        ...
        if (dataStr != null) {
            return new String(EncryptUtils.decryptBase64AES(dataStr.getBytes(), ConfigKtKt.ENT_CONFIG_APPKEY.getBytes(), "" +

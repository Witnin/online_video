...
import com.wsy.online.common.http.config.HeaderInterceptor
import com.wsy.online.common.http.config.KtHttpLogInterceptor
import com.wsy.online.common.http.config.LocalCookieJar
import com.wsy.online.common.http.config.RetryInterceptor
...
//    使用协程形式的 get请求，使用runBlocking，也可以使用suspend修饰
 fun getByCon(params: Map<String, Any>, urlStr: String) = runBlocking {
